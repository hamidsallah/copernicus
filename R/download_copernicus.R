...
#' download_copernicus(product = 'NDVI_1km_V1', begin = '2009-06-01', end = '2009-06-31',
#'                    tileH = 19, tileV = 4)
...
#' download_copernicus(product = 'NDVI_1km_V1', begin = '2009-06-01', end = '2009-06-31', extent = e)
#' }
#'
#' @export
